let weather = {
    "apiKey": "b5a52f8a62be487baf1190007230906",
    fetchWeather: function(city) {
        ...
        .then((response) => {
            if (!response.ok) {
                ...
                document.querySelector(".winddeg").innerHTML = "????";
                document.querySelector(".winddir").innerHTML = "????";
                document.querySelector(".feelslike").innerHTML = "????";
                document.querySelector(".visib").innerHTML = "????";
                document.querySelector(".uvindex").innerHTML = "????";
                document.querySelector(".pressure").innerHTML = "????";
                document.querySelector(".carbmonx").innerHTML = "????";
                document.querySelector(".ozone").innerHTML = "????";
                document.querySelector(".nitrodiox").innerHTML = "????";
                document.querySelector(".sulphdiox").innerHTML = "????";
                document.querySelector(".pm25").innerHTML = "????";
                document.querySelector(".pm10").innerHTML = "????";
                document.querySelector(".usepaindex").innerHTML = "????";
                document.querySelector(".ukdefraindex").innerHTML = "????";
                document.querySelector(".lastupdated").innerHTML = "Last Updated At:" + "&nbsp;" + "????";
                document.querySelector(".sunrise").innerHTML = "????";
                document.querySelector(".sunset").innerHTML = "????";
                document.querySelector(".moonrise").innerHTML = "????";
                document.querySelector(".moonset").innerHTML = "????";
                document.querySelector(".moonphase").innerHTML = "????";
                document.querySelector(".moonillum").innerHTML = "????";        
            }
